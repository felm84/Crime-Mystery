...
export class ContactListPage {
  ...
  private _contacts = this._player.inventory.contacts;

  //#endregion

  /** 
   * ContactListPage constructor
   * @param _player - type from PlayerProvider
  ...
  */
  constructor(
    private _player: PlayerProvider,
  ...
  */
   openModal(element, page) {
    let modal = this._modalCtrl.create(ModalContentPage, element, page);
    modal.present();
  }
  //#endregion
}
